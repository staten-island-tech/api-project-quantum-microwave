...
export const AvengerStrings = {
    ...
    displayImageOne: document.querySelector('.display-image-1'),
    displayImageTwo: document.querySelector('.display-image-2'),
    displayImageThree: document.querySelector('.display-image-3')
}